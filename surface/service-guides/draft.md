...
> [!IMPORTANT]
> Review the [General Safety Precautions](service-guide-repair-overview.md#general-safety-precautions) and [Battery Safety](service-guide-repair-overview.md#Battery-Safety) sections before proceeding with the repair instructions

[Device Identity Information](#device-identity-information)

[Illustrated Service Parts List](#illustrated-service-parts-list)

[Genuine Microsoft Replacement Parts](#genuine-microsoft-replacement-parts)
...
- [Enclosure Replacement](#enclosure-replacement)

- [Removable Solid-State Drive Replacement](#removable-solid-state-drive-replacement)

- [Battery Replacement](#battery-replacement)

- [Audio Jack Replacement](#audio-jack-replacement)

- [Right Speaker Replacement](#right-speaker-replacement)

- [Left Speaker Replacement](#left-speaker-replacement)

- [Micro SD Reader Replacement](#micro-sd-reader-replacement)

- [Display Assembly Replacement](#display-assembly-replacement)

- [Surface Connect Replacement](#surface-connect-replacement)

- [Motherboard Replacement Process](#motherboard-replacement-process)
...
- Motherboard (Refer to the Illustrated Service Parts List)
  ...
  - M1266593 Screws x 2 (Battery FPC Bracket)
    ...
    :::image type="content" source="./images/LT7Repair/media/image16.png" alt-text="A black text with a white background Description automatically generated":::    

...
1. If the brightness successfully adjusts from 0-100% as expected, direct the user to click **Yes** and then click **Continue**.
2. If the brightness fails to adjust from 0-100% as expected, direct the user to click **No** and then click **Continue**.

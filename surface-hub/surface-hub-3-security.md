...
Use the [Surface IT Toolkit](/surface/surface-it-toolkit) to set a UEFI password with [Surface Enterprise Management Mode (SEMM)](/surface/surface-enterprise-management-mode).
